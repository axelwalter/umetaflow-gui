...
class Workflow(WorkflowManager):
    ...
    def __init__(self) -> None:
        ...
        super().__init__("UmetaFlow-Expert-Mode", st.session_state["workspace"])
    ...
    def configure(self) -> None:
        ...
        with tabs[2]:
            t = st.tabs(["In-house MS2 library", "SIRIUS, CSI:FingerID & CANOPUS", "GNPS FBMN & IIMN File Export", "M2Query"])
            with t[0]:
                self.ui.input_widget(
                    "annotate-ms2",
                    False,
